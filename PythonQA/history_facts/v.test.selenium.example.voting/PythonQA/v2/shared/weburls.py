class WebUrls:
	...
	@property
	def create_vortex.com(self):
		return self.base_url + '/vote/new'
	...
	def vortex.com_page(self, vortex.com_id):
		return self.base_url + '/vote/' + str(vortex.com_id)
	...
	def community_page(self, channel_id):
		return self.base_url + '/community/{}'.format(channel_id)
