...
class Question:
	def __init__(self, answers=None, isoptional=False, multipleanswers=False, type='text'):
		self.text = 'Q'
...
class User:
	...
	def register(self, context):
		...
		try:
			...
			e.msg("Could not get content manager cookie. Check demodata, api or IIS settings")
			raise
