...
class TestMillikartHost2Host:
    ...
    def test_settings_edit(self, direction, env):
        ...
        millikart_settings = self.default_edit.usd_default(h2h_settings)
        self.default_edit.settings_input(settings_to=millikart_settings)
    ...
    def test_h2h_init(self, direction, env):
        ...
        if direction == 'production':
            ...
            processingUrl, status = self.common.h2h_init(env, 'USD', pan_card=env['CARD_NUMBER'],
    ...
    def test_metabase(self, env):
        self.common = CommonHost2Host()
        self.common.metabase(self.base, 'USD', 'Millikart')
