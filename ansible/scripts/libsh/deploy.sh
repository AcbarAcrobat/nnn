...
pipelinename="all_services_deployer"
    ...
    |
    * ENVIRONMENT  * PRODUCT * USER  * PASS   * APPS   * RUNTYPE     * CLOUD_TYPE  * A_VAULT_PASS  * REGISTRY_URL         * PROJECT_NAMESPACE  * GIT_GROUP  * VERSION   * SECURITY * CLUSTER_TYPE
     [${GREEN}development${NC}]  [${RED}vortex${NC}]  [user]  [pass]   [rails]  [${GREEN}print_only${NC}]  [${BLUE}bare${NC}]        [vault_pass]    [registry.domain.com]  [vortex_engine]      [vortex]     [1234-sha]  [${GREEN}pci${NC}]      [k8s]
