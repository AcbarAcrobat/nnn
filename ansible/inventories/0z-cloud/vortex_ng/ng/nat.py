        ...
        for g in inventory_object:
            ...
            if type(g) == dict:
                ...
                if g in 'ip':
                    ...
                    if connection_type_result in "public":
                        ...
                        if connection_type_result in "private":
                            ...
                            print("You select a non supported type of connection type, possible values [public] or [private]")
...
def main(argv):
    ...
    if args.connection_type in "public":
        # print("You selected a Public connection to infrastructure for regeneration of static inventory via Primary IP")
        connection_type_result = "public"
    else:
        if args.connection_type in "private":
            # print("You select Private connection to infrastructure for regeneration of static inventory via Second IP")
