...
def main(argv):
    ...
    parser.add_argument('--file', help='File to open, default bootstrap_vms/group_vars/.alicloud.cloud.run.yml', 
            default='bootstrap_vms/group_vars/.alicloud.cloud.run.yml')
